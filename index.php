    ...
    if (count($_FILES['upload']['name']) > 0) {
        ...
        for ($i = 0; $i < count($_FILES['upload']['name']); $i++) {
            ...
            if (!preg_match("/.(jpg|png)$/i", $_FILES['upload']['name'][$i])){
                echo '<div id="error"><span id="closebtn">&times;</span> <b>ERROR:</b> Selecteer alstublieft een correct foto bestand.</div>';
                die();
            } else {
                ...
                if ($tmpFilePath != "") {
                    ...
                    echo "<br><div id='error'><span id='closebtn'>&times;</span><b>ERROR:</b> Er was een probleem tijdens het uploaded van uw bestand. Probeer het later opnieuw.</div>";
                    die();
                }
            }
        }
    ...
    switch ($size) {
        ...
        case "ander":
            ...
            if ($wijd !== "" && $hoog !== "") {
                ...
                echo "<div id='error'><span id='closebtn'>&times;</span>ERROR: Voer alstublieft de hoogte en breedte voor de foto's in</div>";
